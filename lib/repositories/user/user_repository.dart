...
class UserRepository extends BaseUserRepository {
  ...
  void followUser({required String userId, required String followUserId}) {
    // Add followUser to user's userFollowing collection
    _firebaseFirestore
        ...
        .doc(followUserId)
        .set({});
    // Add user to followUser's userFollowers collection
    _firebaseFirestore
  ...
  void unfollowUser({required String userId, required String unfollowUserId}) {
    ...
    _firebaseFirestore
        ...
        .doc(unfollowUserId)
        .delete();
    // Remove user from unfollowUser's userFollowers collection
    _firebaseFirestore
        .collection(Paths.followers)
        .doc(unfollowUserId)
        .collection(Paths.userFollowers)
